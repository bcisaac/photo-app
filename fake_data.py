...
def generate_user():
    ...
    profile_url = generate_image(id=image_id, width=100, height=100)
    thumb_url = generate_image(id=image_id, width=70, height=70)
...
def generate_posts(n=10, width=800, height=600):
    '''
